...
from vanila_deep_q_learning_convolution_network import vanila_deep_q_learning_convolution_network
from vanila_deep_q_learning_linear_network import vanila_deep_q_learning_linear_network
...
if __name__ == '__main__':
    ...
    if 'vanila_deep_q_learning_linear_network' in runs:
        print("+------------------------------------------+")
        print("|                                          |")
        print("|       STARTING SIMPLE DEEP Q-ALGO        |")
        ...
        env.print_environment_parameters()
        env.print_on_board_current_state()
        agent = vanila_deep_q_learning_linear_network(env, size)
    ...
    if 'vanila_deep_q_learning_convolution_network' in runs:
        print("+------------------------------------------+")
        print("|                                          |")
        print("|       STARTING SIMPLE DEEP Q-ALGO        |")
        print("|            Replay buffer: No             |")
        ...
        env.print_environment_parameters()
        env.print_on_board_current_state()
        agent = vanila_deep_q_learning_convolution_network(env, size)
